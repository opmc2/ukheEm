...
load("~/Dropbox/work/myRpkgs/ukheEm/data/resultsVersionPaper/resBcsCogNoncog_female.rda")
dtBcs4Bs <- resBcsCogNoncog_female[[5]][[3]]
# reorder types by mu
...
for (iter in 1:5) {
  ...
  saveRDS(resBcsBs, file = paste0("data/resBcsBsCN_femaleK5_FSsvBsW_", iter, ".rds"))
