...
dtBcs <- merge(
  ...
  merge(bcs70$bcs1986x[, .(bcsid, ethnicGroup = c6.14, townCity = c6.13)], 
        by = "bcsid") %>%
...
stargazer::stargazer(nocontrols_m, cog_m, cognoncog_m, allcontrols_m,
                     nocontrols_f, cog_f, cognoncog_f, allcontrols_f,
