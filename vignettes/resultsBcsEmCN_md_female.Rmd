...
resBcs <- resBcsCN_md_female
maxK1 <- 6 # cognitive score
maxK2 <- 6 # noncognitive score

maxK <- length(resBcs)

# directories
figDir <- "vignettes/fig/BcsCN_md_female"
...
dtWagePrem[, nTypes := factor(nTypes, nTypesLevels)]
...
ggplot(data = dtWPuncond,
  ...
  scale_colour_manual(name = NULL,
                      ...
                      limits = c("ATE", "ATT")) +
  theme_classic() +
  theme(text = element_text(size = 25), legend.position = c(.9, .2))
