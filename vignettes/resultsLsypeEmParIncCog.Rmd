...
# directories
figDir <- "vignettes/fig/LsypeParIncCog"
dir.create(here(figDir))

resLsype <- resLsypeParIncCog
...
# reorder types by mu
bigDt[, oldType := type]
bigDt[, muC := Hmisc::wtd.mean(w, pk), by = .(nTypes, type)]
bigDt[, type := frank(muC, ties.method = "dense"), by = .(nTypes)]
