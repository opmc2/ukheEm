...
# directories
figDir <- "vignettes/fig/BcsCog_female"
dir.create(here(figDir))

resBcs <- resBcsCog_female
...
ggplot() +
  ...
  annotate(geom = "label", x = 61, y = 0.25, label = "Graduates (d = 1)", colour = "#00BFC4") +
  annotate(geom = "label", x = 63, y = 0.00, label = "Non-graduates (d = 0)", colour = "#F8766D") +
  annotate(geom = "label", x = 40, y = 0.41, label = "Type 1") +
  annotate(geom = "label", x = 58, y = 0.41, label = "Type 2") +
  annotate(geom = "label", x = 77, y = 0.41, label = "Type 3") +
  # annotate(geom = "label", x = 79, y = 0.41, label = "Type 4") +
...
ggplot() +
  ...
  annotate(geom = "label", size = 5, x = 61, y = 0.25, label = "Graduates (d = 1)", colour = "#00BFC4") +
  annotate(geom = "label", size = 5, x = 63, y = 0.00, label = "Non-graduates (d = 0)", colour = "#F8766D") +
  annotate(geom = "label", size = 5, x = 40, y = 0.41, label = "Type 1") +
  annotate(geom = "label", size = 5, x = 58, y = 0.41, label = "Type 2") +
  annotate(geom = "label", size = 5, x = 77, y = 0.41, label = "Type 3") +
  # annotate(geom = "label", x = 79, y = 0.41, label = "Type 4") +
  scale_size_area(max_size = 20) +
  scale_x_continuous(name = "Cognitive") +
  scale_y_continuous(name = "Noncognitive") +
...
xtable::xtable(dtSumStatsK3Pk, digits = 2)
