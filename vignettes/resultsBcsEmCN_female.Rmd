...
ggplot() +
  ...
  annotate(geom = "label", x = 54, y = 0.3, label = "Type 4") +
  annotate(geom = "label", x = 67, y = 0.22, label = "Type 3") +
...
ggplot() +
  ...
  annotate(geom = "label", size = 5, x = 54, y = 0.3, label = "Type 4") +
  annotate(geom = "label", size = 5, x = 67, y = 0.22, label = "Type 3") +
