...
# directories
figDir <- "vignettes/fig/BcsCN"
dir.create(here(figDir))

resBcs <- resBcsCogNoncog
...
bigDtK6 <- merge(
  bigDt[nTypes == 6, .(id, alpha1, sigmaY1, mu, sigmaW, w, y1, z, d, type, pk)], 
  dtBcsWorkerFirm, 
  by = "id"
) %>% 
...
xtable::xtable(dtSumStatsK6Pk, digits = 2)
